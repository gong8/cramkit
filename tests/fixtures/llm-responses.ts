...
export const lectureNotesResponse = {
	concepts: [
		...
		{ name: "Sturm-Liouville Theory", description: "Eigenvalue problems for second-order ODEs" },
		{
			...
			description: "PDEs with boundary conditions",
			aliases: "BVP",
		},
	],
	file_concept_links: [
	...
	concept_concept_links: [
		{
			sourceConcept: "Separation Of Variables",
			targetConcept: "Fourier Series",
			relationship: "prerequisite",
			confidence: 0.85,
		},
		{
			sourceConcept: "Heat Equation",
			targetConcept: "Wave Equation",
			relationship: "related_to",
			confidence: 0.7,
		},
		{
			sourceConcept: "D'Alembert's Solution",
			targetConcept: "Wave Equation",
			relationship: "special_case_of",
			confidence: 0.9,
		},
		{
			sourceConcept: "Sturm-Liouville Theory",
			targetConcept: "Separation Of Variables",
			relationship: "prerequisite",
			confidence: 0.8,
		},
	],
...
export const pastPaperResponse = {
	...
	question_concept_links: [
		...
		{
			questionLabel: "Q1(b)",
			conceptName: "Well-Posedness",
			relationship: "tests",
			confidence: 0.85,
		},
		{
			questionLabel: "Q2",
			conceptName: "Heat Equation",
...
export const problemSheetResponse = {
	...
	question_concept_links: [
		...
		{
			questionLabel: "Q2",
			conceptName: "Separation Of Variables",
			relationship: "applies",
			confidence: 0.8,
		},
	],
...
export const responseWithUnknownConcepts = {
	...
	question_concept_links: [
		{
			questionLabel: "Q1",
			conceptName: "Nonexistent Concept",
			relationship: "tests",
			confidence: 0.7,
		},
	],
